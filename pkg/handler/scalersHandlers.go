...
func listScalers(w http.ResponseWriter, r *http.Request) {
	cfg := config.Get()
	vars := mux.Vars(r)
	u := model.MakeURL(cfg.FaytheURL, "scalers", vars["pid"])
	client := &http.Client{}
...
func createScaler(w http.ResponseWriter, r *http.Request) {
	cfg := config.Get()
	vars := mux.Vars(r)
	u := model.MakeURL(cfg.FaytheURL, "scalers", vars["pid"])
	client := &http.Client{}
...
func deleteScaler(w http.ResponseWriter, r *http.Request) {
	cfg := config.Get()
	vars := mux.Vars(r)
	u := model.MakeURL(cfg.FaytheURL, "scalers", vars["pid"], vars["id"])
	client := &http.Client{}
